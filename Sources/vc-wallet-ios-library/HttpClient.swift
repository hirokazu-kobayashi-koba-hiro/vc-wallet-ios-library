...
public class HttpClient {
    ...
    public func get<T: Decodable>(url: String, headers: [String: String]? = nil, responseType: T.Type) async throws -> T {
            guard let url = URL(string: url) else {
                throw URLError(.badURL)
            }
            ...
            return try handleResponse(response: response, data: data, responseType: responseType)
        }
